...
CREATE TABLE likeliest_child AS
    -- REPLACE THIS LINE
    select a.word, a.category, b.dependency_type, dependent_category, frequency as max_frequency from frequencies
    where dependent_category != 'f' and frequency > .5 and count > 10
    group by category;
