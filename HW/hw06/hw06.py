...
class Mobile:
    ...
    def is_balanced(self):
        ...
        if isinstance(self.left.contents, Mobile):
            l = self.left.contents.is_balanced()
        if isinstance(self.right.contents, Mobile):
            r = self.right.contents.is_balanced()
        return l and r and self.left.torque == self.right.torque
